...
exports.AddEditorDto = exports.CourseFilterDto = exports.UpdateCourseDto = exports.CreateCourseDto = exports.CourseLevel = void 0;
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: CourseLevel }),
    (0, class_validator_1.IsNotEmpty)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: CourseLevel, required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(CourseLevel),
    __metadata("design:type", String)
