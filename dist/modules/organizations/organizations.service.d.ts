...
import { CreateOrganizationDto, UpdateOrganizationDto, AddMemberDto, UpdateMemberRoleDto, CreateRoleDto, UpdateRoleDto, PaginatedResponse, GetMembersDto } from './dto/organizations.dto';
...
export declare class OrganizationsService {
    ...
    addCourses(organizationId: string, courseIds: string[]): Promise<{
        message: string;
